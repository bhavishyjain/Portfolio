  ...
  return (
    <section id="skills" className="w-full h-screen md:h-[150dvh]">
      <div className="top-[70px] sticky mb-96">
        {/* Navigation link to the skills section */}
        <Link href={"#skills"}>
          <BoxReveal width="100%">
            ...
            <h2
              className={cn(
                ...
                "bg-gradient-to-b from-black/80 to-black/50", // Light mode gradient
                "dark:bg-gradient-to-b dark:from-white/80 dark:to-white/20 dark:bg-opacity-50 " // Dark mode gradient
              )}
            >
              SKILLS
            </h2>
